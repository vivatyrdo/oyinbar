const GAMES = [
  {
    ...
    difficulty: 3,
    players: '1 ойыншы',
    pageUrl: '/smartgames/mahjong1.html', // <-- НОВАЯ ССЫЛКА НА СТРАНИЦУ
    image: 'mahjong-preview.jpg',
  ...
  },
  {
    ...
    difficulty: 2,
    players: '1-2 ойыншы',
    pageUrl: '/smartgames/connect4.html',
    image: '4inrow-jpg.jpg',
  ...
  },
  {
    ...
    difficulty: 2,
    players: '1 ойыншы',
    image: 'solitaire-img.jpg',
    pageUrl: '/smartgames/solitaire.html',
  ...
  },
  {
    ...
    color: '#7c4dff',
    difficulty: 3,
    image: 'chinese-img.jpg',
    players: '2-6 ойыншы',
    pageUrl: '/smartgames/chinese-checkers.html',
  ...
  },
  {
    ...
    color: '#795548',
    difficulty: 3,
    image: 'backgammon-img.jpg',
    players: '2 ойыншы',
    pageUrl: '/smartgames/backgammon.html',
  ...
  },
  {
    ...
    difficulty: 4,
    players: '1 ойыншы',
    image: 'spidersolitaireblue-img.jpg',
    pageUrl: '/smartgames/spider.html',
  ...
  },
  {
    ...
    difficulty: 2,
    players: '1 ойыншы',
    image: 'pyramide-img.jpg',
    pageUrl: '/smartgames/pyramid.html',
  ...
  },
  {
    ...
    difficulty: 2,
    players: '1 ойыншы',
    image: 'bubble-img.jpg',
    pageUrl: '/smartgames/bubble-shooter.html',
  ...
  },
  {
    ...
    difficulty: 2,
    players: '1 ойыншы',
    image: 'tri-peaks-img.jpg',
    pageUrl: '/smartgames/tri-peaks.html',
  ...
  },
  {
    ...
    difficulty: 2,
    players: '2-4 ойыншы',
    image: 'domino-img.jpg',
    pageUrl: '/smartgames/domino.html',
  ...
  },
  {
    ...
    difficulty: 2,
    players: '2 ойыншы',
    image: 'dots-and-boxes-img.jpg',
    pageUrl: '/smartgames/dots-and-boxes.html',
  ...
  },
  {
    ...
    difficulty: 3,
    players: '2 ойыншы',
    image: 'chechkers-img.jpg',
    pageUrl: '/smartgames/chechkers.html',
  ...
  },
  {
    ...
    difficulty: 3,
    players: '1 ойыншы',
    image: 'binairo-img.jpg',
    pageUrl: '/smartgames/binairo.html',
  ...
  },
  {
    ...
    difficulty: 3,
    players: '2 ойыншы',
    image: 'gomoku-img.jpg',
    pageUrl: '/smartgames/gomoku.html',
  ...
  },
  {
    ...
    difficulty: 3,
    players: '4 ойыншы',
    pageUrl: '/smartgames/hearts.html',
    image: 'hearts-img.jpg',
  ...
  },
  {
    ...
    difficulty: 5,
    players: '1 ойыншы',
    image: 'killer-sudoku-img.jpg',
    pageUrl: '/smartgames/killer-sudoku.html',
  ...
  },
  {
    ...
    difficulty: 2,
    players: '1 ойыншы',
    image: 'water-sort-img.jpg',
    pageUrl: '/smartgames/water-sort.html',
  ...
  },
  {
    ...
    difficulty: 3,
    players: '2-4 ойыншы',
    image: 'yahtzee-img.jpg',
    pageUrl: '/smartgames/yahtzee.html',
  ...
  },
  {
    ...
    difficulty: 2,
    players: '2 ойыншы',
    pageUrl: '/smartgames/sea-battle.html',
    image: 'sea-battle-img.jpg',
  ...
  },
  {
    ...
    difficulty: 4,
    players: '1 ойыншы',
    image: 'kakurasu-img.jpg',
    pageUrl: '/smartgames/kakurasu.html',
  ...
  },
  {
    ...
    difficulty: 2,
    players: '1 ойыншы',
    image: 'mahjong-connect-img.jpg',
    pageUrl: '/smartgames/mahjong-connect.html',
...
const SIDEBAR_SECTIONS = [
  {
    section: 'Жылдам өту',
    items: [
      { id: 'all',    icon: '🎮', label: 'Барлық ойындар', action: 'filter', href: 'index.html' },
...
function renderSidebar() {
  ...
  SIDEBAR_SECTIONS.forEach(sec => {
    // Используем sec.section
    html += `<div class="sidebar-section"><div class="sidebar-title">${sec.section}</div>`;
    sec.items.forEach(item => {
      // Если есть href, используем его. Иначе ставим data-action
      const attrs = item.href 
        ? `href="${item.href}"` 
        : `href="#" data-action="${item.action}" data-id="${item.id}"`;
        
      html += `<a ${attrs} class="sidebar-link${item.active ? ' active' : ''}">
  ...
  let dhtml = '';
  SIDEBAR_SECTIONS.forEach(sec => {
    dhtml += `<div class="drawer-section"><div class="drawer-section-title">${sec.section}</div>`;
    sec.items.forEach(item => {
      const attrs = item.href 
        ? `href="${item.href}"` 
        : `href="#" data-action="${item.action}" data-id="${item.id}"`;
        
      dhtml += `<a ${attrs} class="drawer-link${item.active ? ' active' : ''}">
        <span class="drawer-icon">${item.icon}</span>${item.label}
      </a>`;
    });
    dhtml += `</div>`;
  });
  if (drawerBody) drawerBody.innerHTML = dhtml;
}

// ===== СЛУЧАЙНАЯ ИГРА (САЙДБАР) =====
document.addEventListener('click', e => {
  ...
  // Если нажали на категорию в сайдбаре, которой нет в "Ой ойындары" (например "Атыс")
  // Перенаправляем на главную страницу с этим фильтром
  if (action === 'filter') {
    window.location.href = `/?filter=${link.dataset.id}`;
  }
});
  ...
  grid.innerHTML = filtered.map((g, i) => `
    <a href="${g.pageUrl || '#'}" class="game-card" data-id="${g.id}" style="animation-delay:${i * 0.04}s">
      ...
      <div class="card-thumb">
        ${g.image 
          ? `<img src="../img/${g.image}" alt="${g.title}">` 
          : `<div class="card-thumb-fallback" style="background: linear-gradient(135deg, ${g.color}55, #111);">${g.emoji}</div>`
        }
      </div>

      <!-- Затемнение и всплывающий текст -->
      <div class="card-overlay">
        <div class="card-meta">
          <span class="card-badge" style="background-color: ${g.color}33; color: ${g.color}; border: 1px solid ${g.color}66;">${g.category}</span>
          <div class="card-diff">${renderDots(g.difficulty)}</div>
        </div>
        
        <div class="card-title">${g.title}</div>
        
        <!-- Этот блок будет расширяться при наведении -->
