  ...
  grid.innerHTML = filtered.map((g, i) => `
    <a href="${g.pageUrl || '#'}" class="game-card" data-id="${g.id}" style="animation-delay:${i * 0.04}s">
      <div class="card-thumb">
        <div class="card-thumb-inner" style="${g.image ? '' : `background: linear-gradient(135deg, ${g.color}22, ${g.color}11);`}">
  ${g.image 
    ? `<img src="../img/${g.image}" alt="${g.title}" style="width: 100%; height: 100%; object-fit: cover; position: absolute; top: 0; left: 0;">` 
